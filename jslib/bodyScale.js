...
resetScale();
function setWindow(winWidth1, winHeight1) {
	console.log(winWidth1, winHeight1)
	var winWidth = winWidth1;
	var winHeight = winHeight1;
	$(window).resize(function () {
		resetScale();
	});
	function getSize() {//获得窗口大小
	...
	function resetScale() {//调整缩放
		getSize();
		var db = document.body;
		db.style.transform = "scale(" + winWidth / winWidth1 + "," + winHeight / winHeight1 + ")";
		// db.style.transform="scale("+winWidth/2880+","+winHeight/1080+")";
		// db.style.msTransform="scale("+winWidth/2880+","+winHeight/1080+")";
		//	-ms-transform:rotate(7deg); 	/* IE 9 */
		//	-moz-transform:rotate(7deg); 	/* Firefox */
