...
console.log("HashMap.prototype.get(key,defaultValue)，"+ "其中key必须是不为空的字符串。")
return; 
} 
...
console.log("HashMap.prototype.set(key,value)，"+"其中key必须是不为空的字符串。")
return; 
} 
var k = HashMap._hash(key); 
this._table[k] = value; 
...
console.log("HashMap._hash(s) 中的参数s必须是非空字符串。"); 
return; 
} 
